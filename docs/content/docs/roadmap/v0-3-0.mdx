...
4. If changed: rewrites `.lunar-css/__theme__.js`, calls `invalidateTokens()` to clear the LRU cache
...
Planned. Timelines and scope subject to change. Follow [GitHub Releases](https://github.com/eularix/lunar-css/releases) or watch the repo.
