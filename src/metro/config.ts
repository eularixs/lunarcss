...
//   3. Routes the bare specifier `lunarcss/__theme__` to that emitted file
...
const VIRTUAL_SPECIFIER = 'lunarcss/__theme__'
...
export function withLunarCSS<T extends MetroConfigShape>(
  ...
  // 4. Route `lunarcss/__theme__` to the generated file.
